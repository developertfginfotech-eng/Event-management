...
export const assignLead = (id, userIds) => api.post(`/admin/leads/${id}/assign`, { userIds })
export const addAssignee = (id, userId) => api.post(`/admin/leads/${id}/assignees`, { userId })
export const removeAssignee = (id, userId) => api.delete(`/admin/leads/${id}/assignees/${userId}`)
...
export const getDMConversations = () => api.get('/chat/dm/conversations')
export const markDMAsRead = (otherUserId) => api.post(`/chat/dm/${otherUserId}/mark-read`)
